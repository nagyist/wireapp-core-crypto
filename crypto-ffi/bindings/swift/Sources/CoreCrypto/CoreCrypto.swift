...
extension CoreCryptoSwift.MlsPublicGroupStateEncryptionType {
    func convertTo() -> PublicGroupStateEncryptionType {
        switch self {
        case .jweEncrypted: return .JweEncrypted
...
public class CoreCryptoWrapper {
    ...
    public func proteusSessionFromMessage(sessionId: String, envelope: [UInt8]) throws {
        try self.coreCrypto.proteusSessionFromMessage(sessionId: sessionId, envelope: envelope)
    }
